  ...
  <main data-role="content">
	  ...
	  <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
			...
			<section class="content"><?php
			  print render($page['body']);?>
			</section>
			<section class="content"><?php
			  print render($page['our_values']);?>
			</section>
			<section class="content offices"><?php
			  print render($page['our_offices']);?>
			</section>
			<section class="content tabs"><?php
			  print render($page['departments']);?>
			</section>
			<section class="content offers tabs"><?php
			  print render($page['job_offers']);?>
			</section>
